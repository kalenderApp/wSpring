<div id="sidebar">
	<div id="sidebar_top">
		<ul class="widgets">
            ...
            <div class="side_block">
			   ...
			   <?php
				if (is_single()) { ?>
					<h3><?php echo (_e('New posts','lighterblue')); ?></h3>
					<?php } ?>
				<?php
				if (!is_single()) { ?>
					<h3><?php echo (_e('Rand posts','lighterblue')); ?></h3>
				<?php } ?>	
            ...
            <div class="side_block">
                <div class="side_mid">			
                      ...
                      <?php if( function_exists('wp_recentcomments') ) : ?>
							<h3><?php echo (_e("New comments","lighterblue")); ?></h3>
								<ul>
									<?php wp_recentcomments('limit=10&length=16&post=false&smilies=true&administrator=false'); ?>
								</ul>
					  <?php else : ?>
					  <?php echo (_e("<h3>New comments</h3>","lighterblue")); ?>
							<?php
	...
	<div id="sidebar_center">
		<ul class="widgets">
           ...
           <div class="side_block">
               <div class="side_mid">
                   <h3><?php echo (_e('Tags','lighterblue')); ?></h3>
                   <div class="tag_cloud">
           ...
           <div class="side_block">
               <div class="side_mid">
                   <h3><?php echo (_e('Cats','lighterblue')); ?></h3>
                   <ul>
           ...
           <div class="side_block">
               <div class="side_mid">
                   <h3><?php echo (_e('Meta','lighterblue')); ?></h3>
                   <ul>
                      <?php wp_register(); ?>
           ...
           <div class="side_block">
               <div class="side_mid">
                   <h3><?php echo (_e('Links','lighterblue')); ?></h3>
                   <ul>
